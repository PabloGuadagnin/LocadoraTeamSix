...
/**
 * Janela de cadastro de veículo do tipo Caminhão.
 */
public class JanelaCadCaminhao extends JFrame implements ActionListener{
	...
	public void actionPerformed (ActionEvent ev) {
		if(ev.getSource() == this.btnSalvar) { // Botão salva.
		...
		if(ev.getSource() == this.btnLimparCampos) { //Botão limpar
			limparCampos();
		}
		
		if(ev.getSource() == this.btnCancelar) { //Botão cancelar
			limparCampos();
			limparAoFechar();
			setVisible(false);
		}
